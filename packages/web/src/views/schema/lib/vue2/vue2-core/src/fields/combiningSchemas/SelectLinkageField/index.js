...
import retrieveSchema from '../../../../../../utils/schema/retriev';
import getDefaultFormState from '../../../../../../utils/schema/getDefaultFormState';
import { getMatchingOption } from '../../../../../../utils/schema/validate';
    ...
    render(h) {
        ...
        childrenVNodeList.push(
            h(Widget, {
                ...
                class: {
                    validateWidget: true, [`validateWidget-${this.combiningType}`]: true
                },
                props: {
                    schema: this.schema,
                    uiSchema: this.uiSchema,
        ...
        return h('div', [
            ...
            h('div', {
                ...
                class: {
                    appendCombining_box: true, [`${this.combiningType}_appendBox`]: true, [`${pathClassName}-appendBox`]: true
                }
            }, childrenVNodeList)
        ]);
    }
