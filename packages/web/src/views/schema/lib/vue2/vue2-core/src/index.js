...
import { deepEquals } from '../../../../lib/utils/utils';

// 基础公共样式
import '../../../../lib/utils/style/baseForm.scss';
                ...
                globalOptions.COMPONENT_MAP.form, {
                    class: {
                        genFromComponent: true,
                            ...
                            formInline: inline, [`genFromComponent_${this.schema.id}Form`]: !!this.schema.id,
                            layoutColumn: !inline, [`layoutColumn-${layoutColumn}`]: !inline
                    },
                    ref: 'genEditForm',
                    props: {
                        model: self.formData,
