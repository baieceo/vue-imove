...
import { getPathVal, setPathVal } from '../../../../../utils/vueUtils';
import { genId, lowerCase } from '../../../../../utils/utils';

import * as arrayMethods from '../../../../../utils/arrayUtils';
        ...
        handleArrayOperate({
            ...
            if (curStrategy) {
                ...
                if (command === 'add') {
                    ...
                    // 批量添加
                    keysParams = {
                        pushArray: formDataPrams.pushArray.map(() => genId())
                    };
                    ...
                    keysParams = {
                        formData: this.$data,
                        nodePath: 'formKeys',
                        newTarget: formDataPrams.newTarget.map(() => genId())
                    };
                }
