...
import {
    ...
    getPathVal,
    setPathVal
} from '../../../../../lib/utils/vueUtils';

import { validateFormDataAndTransformMsg } from '../../../../../lib/utils/schema/validate';
import { IconQuestion } from '../../../../../lib/utils/icons';
import { fallbackLabel } from '../../../../../lib/utils/formUtils';
...
export default {
    ...
    render(h) {
        ...
        // console.log(99999, self);

        // 是否显示绑定
        // const canShowBinding = label && this.projectData && this.projectData.dataStoreSchema;
